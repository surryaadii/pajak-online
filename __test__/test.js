// const filterByTerm = require('../script.js')

describe("Calculate PPh21", () => {
    test.each([[300000000, 'single', '0', 31900000], [78000000, 'married', '1', 750000], [45000000, 'single', '0', 0], [1000000000, 'married', '3', 203400000]])(
        '.testing(gross: %i, marital: %s, dependant: %i)',
        (grossAmount, marital, dependant, expected) => {
          expect(calculatePPH(grossAmount, marital, dependant)).toBe(expected);
        },
      );
  });
